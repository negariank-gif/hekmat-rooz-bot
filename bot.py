...
quotes_main = [
    ...
    {"text": "آدم وقتی می شکند، تازه می فهمد از چه ساخته شده. شکستن شرط شناختن خود است.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "When a person breaks, they finally understand what they are made of."},
    {"text": "وقتی همه در می روند، خدا می ماند. و شاید همین رفتن ها برای رسیدن به خدا بود.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "When everyone leaves, God remains."},
    {"text": "بعضی زخم ها برای همیشه نمی مانند; فقط جایشان می ماند تا یادت بیاید که زنده بودی.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Some wounds don't last forever; only their scars remain to remind you that you lived."},
    {"text": "در دل هر انسانی چراغی است; عشق آن را روشن می کند و غرور آن را خاموش.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "In every person's heart is a lamp; love lights it and pride extinguishes it."},
    {"text": "تنهایی عذاب نیست اگر با خودت باشی. عذاب آن است که در جمع هم تنها باشی.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Loneliness is not torment if you are with yourself."},
    {"text": "گاهی باید بگذاری بروند تا بفهمی چه داشتی. ولی وقتی فهمیدی، دیگر نگران نباش.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Sometimes you must let them go to understand what you had."},
    {"text": "ریشه درخت را نمی بینی ولی می دانی هست; ایمان هم همین است. نادیدنی اما حامل همه چیز.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "You can't see the roots of a tree, but you know they're there; faith is the same."},
    {"text": "دنیا آینه است; هرچه در آن ببینی بازتاب درون توست. خود را اصلاح کن، دنیا درست می شود.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "The world is a mirror; what you see in it reflects your inner self."},
    {"text": "قلب هر انسانی کتابی است; بخوانش. اما اول یاد بگیر چطور کتاب بخوانی.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Every person's heart is a book; read it."},
    {"text": "کسی که امروز را دوست دارد، نگران فردا نیست. حال را زندگی کن.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "One who loves today is not worried about tomorrow."},
    {"text": "وقتی دیگر نمی توانی ادامه دهی، به یاد بیاور چرا شروع کردی. شروع تو همیشه قوی تر از خستگی توست.", "author": "دل نوشت", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "When you can no longer continue, remember why you started."},
    {"text": "خواندن یعنی سفر بدون ترک خانه. هر کتاب دنیایی است که به روی تو باز می شود.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Reading means traveling without leaving home."},
    {"text": "هر کتابی که می خوانی بخشی از تو می شود. پس مراقب باش چه می خوانی.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Every book you read becomes a part of you."},
    {"text": "کتاب ها آینه ای هستند که ما را با خودمان روبرو می کنند. از این رو برویی نترس.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Books are mirrors that confront us with ourselves."},
    {"text": "وقتی گم می شوی، کتاب بخوان تا خودت را پیدا کنی. صفحات کتاب نقشه راه بازگشت به خود هستند.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "When you are lost, read a book to find yourself."},
    # رومی
    {"text": "سکوت زبان عاشقان است. وقتی زبان از گفتن عاجز است، دل شروع به سخن می کند.", "author": "جلال الدین رومی", "cat": "عشق", "tags": "#عشق #حکمت", "en": "Silence is the language of lovers."},
    {"text": "تو را من چشم در راهم، شباهنگام که می دانم پگاه از پی شب تاریک می آید.", "author": "جلال الدین رومی", "cat": "عشق", "tags": "#عشق #حکمت", "en": "I await you; I know that after the dark night, dawn will come."},
    {"text": "درد عشق را دارویی نیست الا وصال. و وصال را پایانی نیست الا کمال.", "author": "جلال الدین رومی", "cat": "عشق", "tags": "#عشق #حکمت", "en": "The pain of love has no remedy but union."},
    {"text": "جان من جان جهانم می کند. عشق در جانم نهانم می کند.", "author": "جلال الدین رومی", "cat": "عشق", "tags": "#عشق #حکمت", "en": "My soul makes me the soul of the world; love hides within my soul."},
    # مارکوس اورلیوس
    {"text": "ذهن خود را پاک نگه دار. آلودگی ذهن بدتر از آلودگی جسم است.", "author": "مارکوس اورلیوس", "cat": "فلسفه", "tags": "#فلسفه #حکمت", "en": "Keep your mind clean; mental pollution is worse than physical."},
    {"text": "آنچه در توان داری بکن، با آنچه داری، آنجا که هستی.", "author": "مارکوس اورلیوس", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "Do what you can, with what you have, where you are."},
    {"text": "بهترین انتقام، متفاوت بودن از کسی است که به تو آسیب زد.", "author": "مارکوس اورلیوس", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "The best revenge is to be unlike the one who harmed you."},
    # سقراط
    {"text": "من می دانم که هیچ نمی دانم. این اولین قدم به سوی دانستن است.", "author": "سقراط", "cat": "فلسفه", "tags": "#فلسفه #حکمت", "en": "I know that I know nothing; this is the first step toward knowing."},
    {"text": "زندگی بدون ارزیابی ارزش زیستن ندارد. هر شب از خود بپرس: امروز چه کردم؟", "author": "سقراط", "cat": "فلسفه", "tags": "#فلسفه #حکمت", "en": "The unexamined life is not worth living."},
    # ابوعلی سینا
    {"text": "دل را به علم و دانش بساز که علم نور است و جهل تاریکی.", "author": "ابوعلی سینا", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "Build your heart with knowledge; knowledge is light and ignorance is darkness."},
    {"text": "درمان بیشتر بیماری ها در خود ماست; صبر، آرامش و امید بهترین داروهایند.", "author": "ابوعلی سینا", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "The cure for most ailments is within us; patience, calm, and hope are the best medicines."},
    # ناپلئون هیل
    {"text": "آنچه ذهن می تواند تصور کند و به آن ایمان آورد، می تواند به دست آورد.", "author": "ناپلئون هیل", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "Whatever the mind can conceive and believe, it can achieve."},
    # پائولو کوئلیو
    {"text": "وقتی چیزی را از ته دل بخواهی، تمام کیهان دست به دست هم می دهد تا به آن برسی.", "author": "پائولو کوئلیو", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "When you want something, all the universe conspires in helping you to achieve it."},
    {"text": "پیش از رسیدن به رویا، باید از همه چیزی که داری دست بکشی.", "author": "پائولو کوئلیو", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "Before a dream is realized, you must give up everything you have."},
    # رابیندرانات تاگور
    {"text": "من خواب دیدم که زندگی شادی است. بیدار شدم و دیدم زندگی خدمت است. خدمت کردم و دیدم که خدمت شادی است.", "author": "رابیندرانات تاگور", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "I dreamed that life was joy. I woke and saw that life was service. I served and saw that service was joy."},
    # مادر ترزا
    {"text": "اگر به همه انسان ها محبت نمی کنی، حداقل به یک نفر آسیب نزن.", "author": "مادر ترزا", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "If you can't love everyone, at least don't hurt anyone."},
    {"text": "ما همه می توانیم کارهای بزرگ انجام دهیم. ولی اگر با محبت کوچک عمل کنیم، دنیا عوض می شود.", "author": "مادر ترزا", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "We can do no great things; only small things with great love."},
    # احادیث و روایات
    {"text": "هر کس خود را بشناسد، خدا را شناخته است. خودشناسی آغاز خداشناسی است.", "author": "حکمت اسلامی", "cat": "عرفان", "tags": "#عرفان #حکمت", "en": "Whoever knows himself, knows God."},
    {"text": "به کسی که به تو بدی کرده نیکی کن; که این نه ضعف، بلکه قدرت است.", "author": "حکمت اسلامی", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "Do good to one who has done evil to you; this is not weakness, but strength."},
    # جملات فلسفی جدید
    {"text": "زندگی همان است که در فاصله برنامه ریزی های ما اتفاق می افتد. پس لحظه را دریاب.", "author": "دل نوشت", "cat": "فلسفه", "tags": "#فلسفه #حکمت", "en": "Life is what happens in the gaps between our plans."},
    {"text": "خوشبخت نیست آن که همه چیز دارد، خوشبخت است آن که از آنچه دارد راضی است.", "author": "دل نوشت", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "Happy is not the one who has everything, but the one who is satisfied with what they have."},
    {"text": "گاهی سخت ترین کار، رها کردن چیزی است که قرار بود خوب باشد ولی نشد.", "author": "دل نوشت", "cat": "دل_نوشت", "tags": "#دل_نوشت #احساس", "en": "Sometimes the hardest thing is letting go of something that was supposed to be good."},
    {"text": "آنچه را که نمی توانی تغییر دهی، بپذیر. آنچه را که می توانی، تغییر بده. و حکمت داشته باش که تفاوت را بدانی.", "author": "دل نوشت", "cat": "حکمت", "tags": "#حکمت #عرفان", "en": "Accept what you cannot change; change what you can; and have the wisdom to know the difference."},
    {"text": "بهترین سرمایه گذاری، سرمایه گذاری بر روی خودت است. هیچ بازدهی بالاتری وجود ندارد.", "author": "دل نوشت", "cat": "انگیزشی", "tags": "#انگیزشی #حکمت", "en": "The best investment is investing in yourself."},
]
